...
class Calibration(QtGui.QWidget):
    def __init__(self, parent=None):
        ...
        self.filterOP = QtGui.QPushButton("Activate Filter", self)
        self.filterOP.setCheckable(True)
        self.filterOP.clicked[bool].connect(self.filters)

        self.radioB = QtGui.QRadioButton("Blue Tennis Detection")
        self.radioB.toggled.connect(lambda: self.btnstate(self.radioB))

        self.radioG = QtGui.QRadioButton("Green Tennis Detection")
    ...
    ###############################################################################
    # Passing the values to the sliders
    ###############################################################################
    ...
    def btnstate(self, b):
        if b.text() == "Blue Tennis Detection":
            if b.isChecked():
        ...
        if b.text() == "Green Tennis Detection":
            if b.isChecked():
    ...
    ###############################################################################
    # Load the text file with calibrations
    ###############################################################################
